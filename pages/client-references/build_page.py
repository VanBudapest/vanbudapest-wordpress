...
SL_CSS = """
  ...
  #vb-starladder-major .vb-sl-logo{grid-row:span 2;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;background:linear-gradient(160deg,#0E2350 0%,#081733 100%);border:1px solid rgba(245,197,24,.35);border-radius:12px;padding:18px;text-align:center}
  #vb-starladder-major .vb-sl-logo img{width:100%;max-width:220px;height:auto;aspect-ratio:auto;object-fit:contain;border:0;box-shadow:none;border-radius:8px}
  #vb-starladder-major .vb-sl-logo span{color:#F5C518;font-size:.72rem;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;line-height:1.6}
  ...
  @media(max-width:1024px){#vb-starladder-major .vb-sl-grid{grid-template-columns:repeat(2,1fr);grid-auto-rows:clamp(140px,24vw,230px)}#vb-starladder-major .vb-sl-a{grid-column:span 2;grid-row:span 2}#vb-starladder-major .vb-sl-b{grid-row:span 2}}
...
<style>{SL_CSS}</style>
  ...
  <div class="vb-sl-grid">
    ...
    <img src="{U}{sl639}-1536x1024.webp" alt="VanBudapest chauffeur beside a Mercedes minibus on StarLadder Major transfer duty at Budapest Airport" width="1536" height="1024" srcset="{ss639}" sizes="(max-width:1024px) 50vw, 25vw" loading="lazy" decoding="async">
    <img src="{U}{sl621}-1536x1024.webp" alt="StarLadder Major Budapest team transfer badges held at the airport terminal" width="1536" height="1024" srcset="{ss621}" sizes="(max-width:1024px) 50vw, 25vw" loading="lazy" decoding="async">
    <div class="vb-sl-logo">
      <img src="{U}2025/11/Starladder-Major-Budapest-2025.jpg" alt="StarLadder Major Budapest 2025 official tournament logo" width="1100" height="700" loading="lazy" decoding="async">
      <span>Esports Logistics<br>Since 1988 on the Road</span>
    </div>
  </div>
  <div class="vb-cr-cta">
